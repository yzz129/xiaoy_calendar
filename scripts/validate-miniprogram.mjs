...
const required = [
  ...
  'pages/theme/theme.js', 'pages/theme/theme.json', 'pages/theme/theme.wxml', 'pages/theme/theme.wxss',
  ...
  'pages/admin/admin.js', 'pages/admin/admin.json', 'pages/admin/admin.wxml', 'pages/admin/admin.wxss',
...
const allowedWxmlTags = new Set(['block', 'view', 'text', 'image', 'button', 'navigator', 'input', 'textarea', 'label', 'picker', 'scroll-view', 'slider', 'switch'])
