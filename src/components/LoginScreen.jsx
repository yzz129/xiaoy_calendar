  ...
  return (
    <main className="auth-page">
      <section className="auth-card" aria-labelledby="auth-title">
        ...
        {!adminMode && !isNativeApp() ? <a className="auth-download" href={APK_DOWNLOAD_URL} download><Download /><span><strong>下载 Android APP</strong><small>安装最新版，在手机桌面直接使用</small></span></a> : null}
