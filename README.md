...
- 支持上传 JPG、PNG、WebP 壁纸；选图后立即预览并在本机应用配色，免费视觉模型最多等待 7 秒
- 壁纸使用完整画面适配，不再为铺满屏幕强制截断主体；压缩皮肤优先同步，较大的原图随后在后台归档
...
- 手机端首页按动态视口高度自适应，系统字体放大或短屏设备不再截断底部日期卡片
- 网页端按 1080p、2K、4K 屏幕自适应放大并充分利用宽高；自定义壁纸使用清晰主体与模糊延展层铺满超宽屏
...
- 主题装扮支持云朵体、跟随系统字体、明暗配色与完整画面适配的自定义皮肤
